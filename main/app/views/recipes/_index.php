    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <article class="bg-white rounded-lg overflow-hidden shadow-lg relative">
            ...
            <div class="p-4">
                ...
                <a href="recipes/<?php echo $dish['recipe_id']; ?>/<?php echo Core\Tools\slugify($dish['recipe_name']); ?>" class="inline-block mt-4 bg-red-500 hover:bg-red-800 rounded-full px-4 py-2 text-white">
                    Voir la recette
                </a>
            </div>
        </article>
